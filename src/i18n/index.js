...
export const translations = {
  ...
  'en-US': {
    ...
    chainEntry: 'Entry Source',
    chainExit: 'Exit Source',
    chainSelect: 'Select subscription or node',
    chainInvalid: 'Select two different valid subscriptions or nodes',
  ...
  'fa': {
    ...
    chainEntry: 'اشتراک/گره ورودی',
    chainExit: 'اشتراک/گره خروجی',
    chainSelect: 'انتخاب اشتراک یا گره',
    chainInvalid: 'دو اشتراک یا گره معتبر و متفاوت انتخاب کنید',
  ...
  'ru': {
    ...
    chainProxy: 'Цепочка прокси',
    chainEntry: 'Входная подписка/узел',
    chainExit: 'Выходная подписка/узел',
    chainSelect: 'Выберите подписку или узел',
    chainInvalid: 'Выберите две разные действительные подписки или узла',
