...
export const translations = {
  ...
  'en-US': {
    ...
    chainEntry: 'Entry Subscription',
    chainExit: 'Exit Subscription',
    chainSelect: 'Select subscription',
    chainInvalid: 'Select two different valid subscriptions',
  ...
  'fa': {
    ...
    chainEntry: 'اشتراک ورودی',
    chainExit: 'اشتراک خروجی',
    chainSelect: 'انتخاب اشتراک',
    chainInvalid: 'دو اشتراک معتبر و متفاوت انتخاب کنید',
  ...
  'ru': {
    ...
    chainEntry: 'Входная подписка',
    chainExit: 'Выходная подписка',
    chainSelect: 'Выберите подписку',
    chainInvalid: 'Выберите две разные действительные подписки',
